...
[void][System.Reflection.Assembly]::LoadWithPartialName( "Microsoft.VisualBasic")
    ...
    Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/mats-lenander_aaglobal/OSDCloud/dev/OSBuild.csv' -Outfile OSBuild.csv 
...
if ($result.Response -eq 0) {
    ...
    Invoke-WebRequest -Uri 'https://github.com/mats-lenander_aaglobal/OSDCloud/dev/PCPKsp.dll' -OutFile X:\Windows\System32\PCPKsp.dll
